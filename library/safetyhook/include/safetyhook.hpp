...
namespace safetyhook
{
    ...
    constexpr T address_cast(U address)
    {
...
namespace safetyhook
{
    ...
    public:
        ...
        template <typename T>
        [[nodiscard]] T original() const { return reinterpret_cast<T>(m_trampoline.address()); }
...
namespace safetyhook
{
    ...
    public:
        ...
        template <typename T>
        [[nodiscard]] T original() const { return reinterpret_cast<T>(m_original_vm); }
...
namespace safetyhook
{
    ...
    template <typename T>
    [[nodiscard]] VmHook create_vm(VmtHook &vmt, size_t index, T destination)
    {
